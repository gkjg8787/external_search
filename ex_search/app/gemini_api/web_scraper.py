...
async def _parse_html(
    ...
    errorcodelog_repository: m_ia_repo.ICodeValidationErrorsRepository,
    recreate: bool = False,
    ...
    sparser = ParserGeneratorForJSON(
        ...
        errorcodelog_repository=errorcodelog_repository,
        url=url,
        recreate=recreate,
        prompt=parserprompt,
    )
...
async def parse_html_and_convert(
    ...
    result = await _parse_html(
        ...
        errorcodelog_repository=ai_repo.CodeValidationErrorsRepository(session),
        recreate=recreate,
